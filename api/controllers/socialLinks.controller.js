...
class SocialLinksController {
    ...
    async Update(req, res) {
        ...
        try {
            await SocialLinks.updateOne({_id:req.body._id},{title:req.body.title,link:req.body.link,updated_at:new Date()})
    ...
    async Get(req, res) {
        try {
            var links = await SocialLinks.find();
    ...
    async Delete(req, res) {
        ...
        try {
            await SocialLinks.deleteOne({_id:linkID})
